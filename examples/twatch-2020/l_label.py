"""
l_label.py example using st7789 driver on a T-Display in Landscape mode
"""
...
label1.set_width(240)                         # Set smaller width to make the lines wrap
